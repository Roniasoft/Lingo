...
//    color: "#17212b";
    ...
    header: Rectangle {
        ...
        Image {
            id: imgSettings
            source: "images/Icons-filled/Settings.png"
            width: 16;
            fillMode: Image.PreserveAspectFit
            anchors.verticalCenter: parent.verticalCenter;
    ...
    background: Rectangle {
        ...
        HighlightButton {
            ...
            iconHoveredSrc: "images/Icons-filled/EditHovered.png"
            iconSrc: "images/Icons-filled/Edit.png"
        ...
        HighlightButton {
            ...
            iconHoveredSrc: "images/Icons-filled/NotificationsHovered.png"
            iconSrc: "images/Icons-filled/Notifications.png"
