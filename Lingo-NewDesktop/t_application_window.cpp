...
TApplicationWindow::TApplicationWindow(QQuickWindow *parent) :
    QQuickWindow(parent),
...
void TApplicationWindow::setResizeable(bool resizeable)
{
...
void TApplicationWindow::setResizeableAreaWidth(int width)
{
    if (1 > width) width = 1;
    m_borderWidth = width;
}

bool TApplicationWindow::isMax()
{
    return _isMax;
}

void TApplicationWindow::showMin()
{
    this->showMinimized();
}

void TApplicationWindow::resizeEvent(QResizeEvent *ev)
{
...
void TApplicationWindow::addIgnoreWidget(QWidget *widget)
{
...
bool TApplicationWindow::nativeEvent(const QByteArray &eventType, void *message, long *result)
{
...
void TApplicationWindow::onTitleBarDestroyed()
{
